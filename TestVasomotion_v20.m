function [output] = TestVasomotion_v20(tapers)
...
for ii = 1:length(file_number)
        f_name = ['5NO_0NOd_5NOsens_50bGC_' num2str(file_number(ii)) 'Hz_20VD_6sNOkernel_GammaWith1Hgb_45_Hct_RawGamma_' state_id{state_i} '_v20.csv'];
