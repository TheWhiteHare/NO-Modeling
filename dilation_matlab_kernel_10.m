...
%%
fileID = fopen([num2str(NO_Mult) 'NO_' num2str(stim_duration) 'NOd_' num2str(NO_sens) 'NOsens_' num2str(basalGC) 'bGC_' num2str(Hz) 'Hz_' num2str(round(radius*2,1)) 'VD_' '6sNOkernel_GammaWith' num2str(pfHgb) 'Hgb_' num2str(round(Hct*100)) '_Hct_RawGamma_static_v26.csv'],'a');
