...
subplot(121), hold on
pt3 = plot(uniform.tissue.NO.radius,uniform.tissue.NO.conc{index50(3),3},'Color',[229 245 249]./256,'LineWidth',3);
pt2 = plot(regional.tissue.NO.radius,regional.tissue.NO.conc{index50(2),3},'Color',[153 216 201]./256,'LineWidth',3);
pt1 = plot(proximal.tissue.NO.radius,proximal.tissue.NO.conc{index50(1),3},'Color',[44 162 95]./256,'LineWidth',3);
