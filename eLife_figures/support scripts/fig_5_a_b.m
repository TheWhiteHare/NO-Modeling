...
legend('impulse response recorded from mouse','fitted Kernel')
...
legend('0.7s recorded from mouse','0.7s simulation: static','0.7s simulation: dynamic','10s recorded from mouse','10s simulation: static','10s simulation: dynamic')
