...
subplot(211),legend('x1 NO sensitivity','x3 NO sensitivity','x5 NO sensitivity','x10 NO sensitivity')
subplot(212),legend('x1 NO sensitivity','x3 NO sensitivity','x5 NO sensitivity','x10 NO sensitivity')
...
for ii = 1:length(static.conc)
    ...
    legend(ax1,'x1 NO sensitivity','x3 NO sensitivity','x5 NO sensitivity','x10 NO sensitivity');
    legend(ax2,'x1 NO sensitivity','x3 NO sensitivity','x5 NO sensitivity','x10 NO sensitivity');
